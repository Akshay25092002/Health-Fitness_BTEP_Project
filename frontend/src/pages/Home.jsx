import heroImg01 from "../assets/images/banner.jpg";
            ...
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
              ...
              <div>
                ...
                <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
                  <div>
                    <h2 className="text-[36px] loading-[56px] lg:text-[44px] lg:loading-[54px] font-[700] text-headingColor">
                      30+
                    </h2>
        ...
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            <h2 className="heading text-center">
              Providing you the best Medical services
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="taxt-[16px] leading-7 text-headingColor font-[400] mt-4 text-center">
                  World-class care for everyone. Our health System offers
                  unmatched, expert health care. From the labe to clinic.{" "}
                </p>
