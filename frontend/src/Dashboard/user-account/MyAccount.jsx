...
const MyAccount = () => {
  //destructre the dispatch function from authcontext
  ...
  //now define logout handler and dispatch action 'LOGOUT'
  const handleLogout = () => {
        ...
        {!loading && !error && (
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="md:col-span-2 md:px-[30px]">
              ...
              {/* if actice tab is bookings then it will render MYBookings component, same for profile */}
